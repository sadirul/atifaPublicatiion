...
class USER
{
    ...
    public function set_alert_tailwind($msg, $type)
    {
        if ($type == "error") {
            $_SESSION['alert'] = '
            <div class="flex items-center p-4 mb-4 text-sm text-red-800 rounded-lg bg-red-50 border border-red-300 relative" role="alert">
                <svg class="flex-shrink-0 inline w-5 h-5 mr-3 text-red-600" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    3.582-8 8-8 8 3.582 8 8zm-8-4a1 1 0 00-.993.883L9 
                    7v4a1 1 0 001.993.117L11 11V7a1 1 0 00-1-1zm0 8a1 
            ...
            $_SESSION['alert'] = '
            <div class="flex items-center p-4 mb-4 text-sm text-green-800 rounded-lg bg-green-50 border border-green-300 relative" role="alert">
                <svg class="flex-shrink-0 inline w-5 h-5 mr-3 text-green-600" fill="currentColor" viewBox="0 0 20 20">
                    ...
                    000 16zm3.707-9.707a1 1 0 00-1.414-1.414L9 
                    10.586 7.707 9.293a1 1 0 00-1.414 
                    1.414l2 2a1 1 0 001.414 0l4-4z" clip-rule="evenodd"/>
                </svg>
                <div>' . $msg . '</div>
                <button type="button" class="absolute top-2 right-2 text-green-500 hover:text-green-700" onclick="this.parentElement.remove()">
                    &times;
                </button>
            </div>';
        }
